...
<body>
    <div class="bg-slate-800 w-full h-screen flex justify-center items-center">
        <div
            ...
            <div
                class="radial absolute bg-violet-600 w-40 h-40 rounded-full mix-blend-multiply blur-xl animate-blob opacity-70 -translate-y-1/2 right-[45%] top-1/2 lg:w-72 lg:h-72"></div>
            <div
                class="radial absolute bg-yellow-600 w-40 h-40 rounded-full mix-blend-multiply blur-xl animate-blob animation-delay-2000 opacity-70 -translate-y-1/2 left-[45%] top-1/2 lg:w-72 lg:h-72"></div>
            <div
                class="radial absolute bg-pink-600 w-40 h-40 rounded-full mix-blend-multiply blur-xl animate-blob animation-delay-4000 delay-[4s] opacity-70 -translate-x-1/2 -translate-y-1/2 left-1/2 top-[55%] lg:w-72 lg:h-72"></div>
            <div
                ...
                <div class="h-[80%] flex flex-col justify-between pt-8">
                        ...
                        <form action="<?= BASEURL ?>/auth/login" method="post">
                            <div>
                                <label for="email"><span
                                        class="block text-sm lg:text-lg 2xl:text-xl text-white after:content-['*'] after:text-pink-600 after:ml-0.5">Email</span>
                                    <input
                                        type="email"
                                        name="email"
                                        id="email"
                            ...
                            <div>
                                <label for="password"><span
                                        class="block text-sm lg:text-lg 2xl:text-xl text-white after:content-['*'] after:text-pink-700 after:ml-0.5">Password</span>
                                    <input
                                        type="password"
                                        name="password"
                                        id="password"
                            ...
                            <div class="flex justify-end">
                                <a href="" class="text-sm lg:text-lg 2xl:text-xl font-light text-white underline">Forgot password</a>
                            </div>
                            <div>
                                <button
                                    type="submit"
                    ...
                    <div class="flex justify-end">
                        <a href="" class="text-sm lg:text-lg 2xl:text-xl font-light text-white underline">Create an account</a>
                    </div>
                </div>
            </div>
            <div
