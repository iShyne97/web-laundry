<div class="w-full h-full mx-auto rounded-box border border-base-content/10 bg-base-100 shadow-lg shadow-slate-50/15 p-5">
        ...
        <form action="<?= BASEURL ?>/pickup/add/<?= $data['transaction']['id'] ?>" method="post">
            <div class="flex justify-between items-center my-5 p-3">
                ...
                <div class="flex justify-end items-end">
                    <?= empty($data['transaction']['order_pay']) ? '<button type="submit" class="btn btn-primary lg:text-lg 2xl:text-xl 2xl:p-6 rounded-full my-2 ">Finish Order</button>' : '' ?>
                </div>
            </div>
            <div>
