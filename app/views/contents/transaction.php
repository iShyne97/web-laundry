            ...
            <tbody>
                <?php foreach ($data as $key => $d) : ?>
                    <tr>
                        ...
                        <td><?= $d['order_status'] == 0 ? '<span class="block text-center rounded-full py-2 px-5 text-sm lg:text-lg bg-blue-400 text-white">In Machine</span>' : '<span class="block text-center rounded-full py-2 px-5 text-sm lg:text-lg bg-green-400 text-white">Retrieved</span>' ?></td>
                        <td>
